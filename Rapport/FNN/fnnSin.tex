...
\begin{tikzpicture}[x=2.4cm,y=1.2cm]
    \readlist\Nnod{1,3,3,1} % array of number of nodes per layer
    ...
    \path (N2-3) --++ (0,1+\yshift) node[midway,scale=1.6] {$\vdots$}; % dots
    \path (N3-3) --++ (0,1+\yshift) node[midway,scale=1.6] {$\vdots$}; % dots
