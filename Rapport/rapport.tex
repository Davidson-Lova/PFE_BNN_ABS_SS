...
\begin{figure}[H]
    ...
    \subfigure[listentry][Résultat]{\includegraphics[width = 0.48\textwidth]{../plots/plotCos-11-04-2023_08-47-51.png}}
...
\begin{figure}[H]
    ...
    \subfigure[listentry][Résultat]{\includegraphics[width = 0.48\textwidth]{../plots/plotSin-11-04-2023_13-51-30.png}}
    \caption[short]{Résultat de l'algorithme BNN-ABC-SS}
\end{figure}

\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width = 0.3\textwidth]{../plots/plotWeight-11-04-2023_13-51-30--153.png}}
    \subfigure[]{\includegraphics[width = 0.3\textwidth]{../plots/plotWeight-11-04-2023_13-51-30--170.png}}
    \subfigure[]{\includegraphics[width = 0.3\textwidth]{../plots/plotWeight-11-04-2023_13-51-30--199.png}}
    \caption[short]{Exemple de distribution a posteriori des poids et biais}
\end{figure}
...
\centering
\begin{tikzpicture}
    \node (img) {\includegraphics[width = 0.6\textwidth]{../plots/plotWeigthJoint-11-04-2023_13-51-30--0&47.png}};
    \node[below=of img, node distance=0cm, yshift=1cm] {$w^{(1)}_{1,1}$};
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.8\textwidth]{../plots/plotIncertitudeSortie-11-04-2023_13-51-30--249&329.png}
