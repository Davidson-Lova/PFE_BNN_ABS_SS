...
\begin{figure}[H]
    ...
    \caption{Résultat de la regression linéaire}
\end{figure}
...
ns = [4,1],
activation : "relu" et
la dissimilarité choisi est l'erreur quadratique moyenne.

\begin{figure}[H]
    \centering
    \subfigure[listentry][Courbe d'évolution des erreurs]{\includegraphics[width = 0.48 \textwidth]{../plots/ErrorRegLin.png}}
    \subfigure[listentry][Tube]{\includegraphics[width = 0.48 \textwidth]{../plots/TubeRegLin.png}}
...
\begin{figure}[H]
    \centering
    \subfigure[listentry][Courbe d'évolution des erreurs]{\includegraphics[width = 0.48 \textwidth]{../plots/ErrorRegNN.png}}
    \subfigure[listentry][Tube]{\includegraphics[width = 0.48 \textwidth]{../plots/TubeNN.png}}
